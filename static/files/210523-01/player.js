...
$(document).ready(function () {
  ...
  audioElement.setAttribute("preload", "metadata"); // for duration
  ...
  audioElement.addEventListener("timeupdate", function () {
    ...
    document.querySelector(".js-playtime").innerHTML = getTime(
      audioElement.currentTime
    ); // for display Play time
    document.querySelector(".js-totaltime").innerHTML = getTime(
